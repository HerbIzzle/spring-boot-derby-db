...
public class UserResource {
    ...
    public User retrieve(@PathVariable long id) {
        ...
        return userRepository.findById(id)
                .orElseThrow(
                        () -> new EmptyResultDataAccessException("can't find user with id " + id, 1)
                );
    }
    ...
    public void delete(@PathVariable long id) {
        ...
        userRepository.deleteById(id);   // throws EmptyResultDataAccessException if news could not be found
    }
